  ...
  <div class="w-192 mx-auto">
    ...
    <div class="mt-8">
      ...
      <form action="{{ route('contact') }}" method="post">
        ...
        <div class="mb-4">
          <label for=name_kana class="block text-left p-1 my-1 font-medium">
              ...
              @if($errors->has('name_kana'))
                  <p class="text-blue-400">{{ $errors->first('name') }}</p>
              @endif
          </label>
        ...
        <div class="mb-4">
          <label for="phone" class="block text-left p-1 my-1 font-medium">
              電話番号
              @if($errors->has('phone'))
        ...
        <div class="mb-4">
          ...
          <textarea id="body" class="w-full h-24 p-4 text-xs leading-none resize-none bg-blueGray-50 rounded outline-none border" type="text" placeholder="ご自由にご記入ください" name="body">
              {{ old('body') }}
          </textarea>
        </div>
